(function(angular) {
    ...
    function MirrorCtrl(
        ...
        $scope.ipAddress = networkInterfaces.wlan1[0].address;
...
console.log("test = asd");
            ...
            AnnyangService.addCommand(command.locaiton, function(location) {
            	console.debug("Getting map of111111", location);
            ...
            var sender = require('remote').getGlobal('sender');
     	    sender.on('android',function(android){
                ...
                else if(androidCommand === command.zoomin) { functionService.zoomin($scope,GeolocationService,MapService); }
    			else if(androidCommand === command.zoomout) { functionService.zoomout($scope,GeolocationService,MapService); }
                else if(androidCommand === command.zoomreset) { functionService.zoomreset($scope,GeolocationService,MapService); }
