...
public class NotiListenService extends NotificationListenerService {
    ...
    private String smartmirror_ip; // 스마트 미러의 ip 주소
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        smartmirror_ip = prefs.getString("SMARTMIRROR_IP", "0.0.0.0"); //"192.168.0.12"
        ...
        if(strPackage.equals("com.facebook.orca") || strPackage.equals("com.facebook.katana") || strPackage.equals("com.android.mms")
                || strPackage.equals("com.kakao.talk") || strPackage.equals("com.google.android.gm") || strPackage.equals("com.android.phone")) {
            ...
            try {
                ...
                /*HttpURLConnection을 이용하여 미러로 GET통신을 통한 전송*/
